...
int main()
{
    ...
    // test_equal(part_one::get_result(input::test), 14);
    // test_equal(part_one::get_result(input::data), 323);
    // test_equal(part_two::get_result(input::test), 34);
    test_equal(part_two::get_result(input::data), 1077);
